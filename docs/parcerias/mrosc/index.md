...
=== "💰 Com transferência de recursos"
    ...
    |-------------|-----------------------|-----------|
    | [Termo de Colaboração](../mrosc/termo-de-colaboracao.md) | Projetos propostos pela administração pública com repasse de recursos | Mapeamento de bens culturais, diagnósticos patrimoniais, campanhas educativas |
    | [Termo de Fomento](../mrosc/termo-de-fomento.md) | Projetos propostos pelas OSCs com transferência de recursos | Iniciativas comunitárias de preservação, festivais tradicionais, projetos de memória oral |

=== "🤝 Sem transferência de recursos"

    | Instrumento | Aplicação no Iepha-MG | Exemplos |
    |-------------|-----------------------|----------|
    | [Acordo de Cooperação](../mrosc/acordo-de-cooperacao.md) | Parcerias para troca de conhecimento, cessão de espaços ou cooperação técnica | Intercâmbio de expertise, uso de instalações, capacitações mútuas |
