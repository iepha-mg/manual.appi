...
=== "ℹ️ Bio"
    ...
    <img src="../assets/images/priscila.jpeg" alt="Priscila Guerra" style="width: 240px; border-radius: 40px; margin-top: 5px; margin-right: 150px">

    <div style="margin-top: 90px; margin-left: -60px">
        <ul>
...
=== "🎓 Formação"
    ...
    - **Especialização** em Economia Criativa e Inovação (UCS, 2022)
    - **Especialização** em Gestão Pública (UEMG, 2018)
...
=== "ℹ️ Bio"
    ...
    <img src="../assets/images/lucas.png" alt="Lucas Fainblat" style="width: 500px; border-radius: 40px; margin-top: 5px; margin-right: 250px">
    ...
    <ul>
        <li>👔 Especialista em Políticas Públicas e Gestão Governamental (EPPGG)</li>
        <li>📧 <a href="mailto:lucas.fainblat@iepha.mg.gov.br">lucas.fainblat@iepha.mg.gov.br</a></li>
        <li>🎓 <a href="http://lattes.cnpq.br/1511692902967161">Lattes</a></li>
    </ul>
    </div>
...
=== "🧑‍🏫 Docência"
    ...
    | ------- | ----------- | ----- | ---------- | ------------- | ----- |
    | 2024-2  | FJP         | Graduação em Administração Pública | Ônus administrativos: o Caronte entre o cidadão e seus direitos | 30h | [Ementa](https://drive.google.com/file/d/1TcihelHycBf-9fT-Txt-t0Ognn_0YCLz/view?usp=sharing)<br><br>[Material do curso](https://kumu.io/fainblat/fjp-202501#onus-administrativos) |
    | 2024-1  | FJP         | Graduação em Administração Pública | Quem entra e quem fica de fora - reprodução de desigualdades na implementação de políticas públicas | 30h | [Ementa](https://drive.google.com/file/d/1Cvuyu2KxzrRIJzxdTdsEKAP_-L1ZpbAL/view?usp=sharing)<br><br>[Material do curso](https://slides.com/lucasfainblat/desigualdades) |
    | 2023-2  | FJP         | Graduação em Administração Pública | Inovação de Impacto: soluções *no code* e *low code* para entraves comuns aos órgãos e entidades do Estado | 30h | [Ementa](https://drive.google.com/file/d/1jgNdQWoFCHCaVDK5o_dhaG_tyh7Rq5fO/view?usp=sharing)<br><br>[Material do curso](https://drive.google.com/file/d/1-n8rZjmgdTnNvnlGTaJKyeL2ASDemWGT/view?usp=sharing) |

=== "🎓 Formação"

    - **Doutorando** em Ciência Política (UFMG, est. 2027)  
    - **Mestrado** em Ciência Política (UFMG, 2024 - [Dissertação](https://repositorio.ufmg.br/items/2b5d7e5a-052a-4ed8-9bb6-004e6cef8bd6))  
    - **Especialização** em Políticas Públicas (UFMG, 2016 - [Monografia]((https://repositorio.ufmg.br/items/38fe0825-a260-4586-a425-0a0d22b36502)))  
    - **Graduação** em [Administração Pública](https://drive.google.com/file/d/1PEOnUQqomcOlZDhZZO3UcgjIvEBBPv2E/view?usp=sharing) (Fundação João Pinheiro, 2011)  
...
A Assessoria de Parcerias e Programas Integrados (APPI) é a unidade do Instituto Estadual do Patrimônio Histórico e Artístico (Iepha-MG) responsável por **propor, desenvolver e coordenar parcerias e
projetos integrados para a proteção, preservação e gestão do patrimônio cultural de Minas
Gerais**.

A APPI articula ações com instituições públicas, privadas e do terceiro setor, promovendo a cooperação e a inovação na preservação do patrimônio.
...
### Competências da APPI

As competências e atribuições da APPI constam no art. 13 do [Decreto Estadual nº 47.921/2020](https://www.almg.gov.br/legislacao-mineira/texto/DEC/47921/2020/?cons=1).
...
<div style="display: flex; align-items: center; justify-content: space-between;">
  ...
  <img src="../assets/images/transparencia.png" alt="Transparência" style="height: 4em; margin-left: 1em;">
</div>

### Integridade

<div style="display: flex; align-items: center; justify-content: space-between;">
  <img src="../assets/images/integridade.png" alt="Integridade" style="height: 4em; margin-right: 2em;">
  <div style="flex: 1;">
...
<div style="display: flex; align-items: center; justify-content: space-between;">
  ...
  <img src="../assets/images/colaboracao.png" alt="Colaboração" style="height: 4em; margin-left: 1em;">
</div>

### Inovação

<div style="display: flex; align-items: center; justify-content: space-between;">
  <img src="../assets/images/inovacao.png" alt="Inovação" style="height: 4em; margin-right: 2em;">
  <div style="flex: 1;">
...
<div style="display: flex; align-items: center; justify-content: space-between;">
  ...
  <img src="../assets/images/simplicidade.png" alt="Simplicidade" style="height: 4em; margin-left: 1em; margin-top: -2em">
</div>